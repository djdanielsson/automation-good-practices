...
+
.Do this: Alpha defaults/main.yml
[source,yaml]
----
include::../examples/collections/do/alpha_defaults_main_yml/defaults/main.yml[]
----
+
.Do this: Beta defaults/main.yml
[source,yaml]
----
include::../examples/collections/do/beta_defaults_main_yml/defaults/main.yml[]
----
====
