...
Examples::
+
.Do this: An example of playbook containing only roles
[source,yaml]
----
...
Examples::
+
.Do this: An example of playbook importing roles with tags
[source,yaml]
----
...
+
.Don't do this (prefer import_role):
[source,yaml]
----
include::playbook_role_tags/playbook_include_bad.yml[]
----
...
Examples::
+
.Do this: Adding verbosity to debug messages
[source,yaml]
----
include::playbook_role_tags/debug_verbosity.yml[]
----
====
