...
[source,yaml]
----
include::../examples/roles/do/ensure_required_facts/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/include_set_vars/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/unique_vars_file_list/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/prepare_test_packages/playbook.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/platform_tasks_first_found/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/platform_tasks_first_found_skip/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/provider_tasks/tasks/main.yml[]
----
...
[source,ini]
----
include::dont_use_groups/bad/inventory[]
----
+
...
[source,yaml]
----
include::dont_use_groups/bad/playbook.yml[]
----
+
...
[source,yaml]
----
include::../examples/roles/do/argument_specs/meta/argument_specs.yml[]
----
====
