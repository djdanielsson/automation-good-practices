...
[source,yaml]
----
include::../examples/roles/do/do_this/playbook.yml[]
----
...
[source,yaml]
----
include::../examples/roles/bad/don_t_do_this.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_03/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_04/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_05/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_06/playbook.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_07/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_08/tasks/main.yml[]
----
...
[source,yaml]
----
include::../examples/roles/do/example_09/tasks/main.yml[]
----
...
+
.Bad: A playbook showing how to loop through a group
[source,yaml]
----
...
+
.Do this: A prefixed task in a sub-tasks file
[source,yaml]
----
include::prefix_subtasks/roles/prefix_show/tasks/sub_prefix.yml[tag=prefix,indent=0]
----
+
The log output will then look something like `TASK [prefix_show : sub_prefix | Show where we are] ****`, which makes it very clear where the task is coming from.
+
...
+
.Do this: Argument Specification file that validates the arguments provided to the role.
[source,yaml]
----
include::../examples/roles/do/argument_specification_file_that_validates_the_arguments_provided_to_the_role/meta/argument_specs.yml[]
----
====
