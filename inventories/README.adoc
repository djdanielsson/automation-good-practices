...
+
.Don't do this: List of hosts in `inventory_bad/host_vars/manager_a/provision.yml`
[source,yaml]
----
...
+
.Don't do this: The "bad" way to loop over hosts
[source,yaml]
----
...
+
.Do this: The "good" way to loop over hosts
[source,yaml]
----
