...
[source,ini]
----
include::inventory_loop_hosts/bad/inventory/groups_and_hosts[]
----
+
Each manager has a list of hosts, which can look like this:
+
.List of hosts in `bad/inventory/host_vars/manager_a/provision.yml`
[source,yaml]
----
include::inventory_loop_hosts/bad/inventory/host_vars/manager_a/provision.yml[]
----
+
...
[source,yaml]
----
include::inventory_loop_hosts/bad/playbook.yml[]
----
+
...
[source,ini]
----
include::inventory_loop_hosts/good/inventory/groups_and_hosts[]
----
+
...
----
$ cat good/inventory/host_vars/host1/provision.yml
provision_value: uno
$ cat good/inventory/group_vars/managed_hosts_a/provision.yml
...
[source,yaml]
----
include::inventory_loop_hosts/good/playbook.yml[]
----
+
...
$ ANSIBLE_STDOUT_CALLBACK=profile_tasks \
	ansible-playbook -i bad/inventory bad/playbook.yml
...
$ ANSIBLE_STDOUT_CALLBACK=profile_tasks \
	ansible-playbook -i good/inventory good/playbook.yml
