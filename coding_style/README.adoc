...
[source,yaml]
----
include::../examples/coding_style/do/list_indentation.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/list_indentation.yml[]
----
====
...
+
.Do this: Usage of the YAML folding sign
[source,yaml]
----
include::../examples/coding_style/do/usage_of_the_yaml_folding_sign/tasks/main.yml[]
----
+
...
[source,yaml]
----
include::../examples/coding_style/do/when_list.yml[]
----
+
.instead of this
[source,yaml]
----
include::../examples/coding_style/bad/when_one_liner.yml[]
----
====
...
[source,yaml]
----
include::../examples/coding_style/do/task_args/playbook.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/task_args/playbook.yml[]
----
====
...
[source,yaml]
----
include::../examples/coding_style/do/unsafe/vars/example.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/unsafe/vars/example.yml[]
----
====
...
[source,yaml]
----
include::../examples/coding_style/do/fqcn/tasks/main.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/fqcn/tasks/main.yml[]
----
====
...
[source,yaml]
----
include::../examples/coding_style/do/task_name/playbook.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/task_name/playbook.yml[]
----
====
...
[source,yaml]
----
include::../examples/coding_style/do/rejectattr/playbook.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/rejectattr/playbook.yml[]
----
...
[source,yaml]
----
include::../examples/coding_style/do/jinja_wrapping/tasks/main.yml[]
----

.Don't do this:
[source,yaml]
----
include::../examples/coding_style/bad/jinja_wrapping/tasks/main.yml[]
----
====
